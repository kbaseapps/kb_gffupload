...
function kb_gffupload(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.fasta_gff_to_genome = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_gffupload.fasta_gff_to_genome",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_gffupload.status",
